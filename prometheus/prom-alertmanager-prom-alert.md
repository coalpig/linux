在alertmanager直接发邮件的基础上有一个prometheusAlert
...
data:
  app.conf: |
    ...
    Email_port=465
    #邮件帐号
    Email_user=li18569630395@163.com
    #邮件密码
    Email_password=GPwAkvyGday9Ea9J
    #邮件标题
    Email_title=PrometheusAlert
    #默认发送邮箱
    Default_emails=li18569630395@163.com
...
spec:
  ...
  - name: node-exporter
    ...
    - alert: NodeFilesystemSpaceLow
      expr: |
        node_filesystem_avail_bytes{mountpoint="/"} / node_filesystem_size_bytes{mountpoint="/"} * 100 < 50
      for: 10s
      labels:
        alertname: NodeFilesystemSpaceLow
        namespace: monitoring
...
stringData:
  alertmanager.yaml: |-
    global:
      ...
      smtp_from: 'li18569630395@163.com'
      smtp_auth_username: 'li18569630395@163.com'
      smtp_auth_password: 'GPwAkvyGday9Ea9J'
      smtp_hello: '163.com'
    ...
    - name: Default
      webhook_configs:
      - url: http://alert-center.local/prometheusalert?type=email&tpl=graylog2-email&email=li18569630395@163.com
        send_resolved: true
